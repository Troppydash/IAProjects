...
\begin{itemize}
 ...
 % perfume
 \item realistic fantasy, description, widely - unappetizing descriptions connect uneasiness. 
 % adjectives
 strong specific adjective. positive adj [9], socially accepted form. but connotations depreciates over extract, from [12] to [15], hides as analogy of slavery, author perception of cost of indust. , key area: interpretation of issues. Ties in with realism, contrast with previous fiction, striking image.
 ...
 \item Metaphor G animals, [7] G as tick slavery as ice-age. Exaggerate power, ties to adjectives exaggerate, powerless against natural disaster, like G. G as in frog connection. Growth stage, reject systematic view romanticism, link [12-15] hides, ease interpretation. Sympathizing, not factual, science approach of perfumes. Develop G as paragon.
 ...
 % fourth of july
 \item extract expressing distress and reform hope. rhetorical [1], aim, structure, signal to move on. Sensitive topic ``slave'' ``04/07``, create emotional response of audience, curiosity. Connect key concept upper class able change.
 \item Direct addressing, personal pronoun answer: [1], establish guilt for crime, pile up pressure, attack beliefs [4]. Pathos in deconstruction values induce anger, analogous   to destruct social slaves, flip dagger. Human right as value but double standard.
 \item personal involvement to personalization [19], slavery as being, contagious disease, common target. Contrast ``abroad'' ``at home'' for wide effects, not end at victims, spread  contaminates, globalization [24-25]. analogy reptile \& leach. End now, responsible.
 \item Context, peak, epicenter, 2/5 households own
 
 % thoughts
 \item Perfume, slavery perceived cost industrial, mock worker [14]. contrast speech slavery unfortunate illness, ignorance host. Ilterary focus adj, adv, character to life; speech personal pronouns, address to guilt, actions taken. Creative: story telling meaning, persuasive: emotion sympathize victims.
\end{itemize}
