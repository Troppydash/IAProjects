...
In summary, the utilties of unquestionable theoretical answers against unanswerable empricial questions depends on the area of knowledge in which the questions and answers are brought within. Theoretical answers are often prefered in mathematics for its lack of empirical observations allows the knowledge within to withstand the test of time, but is vulnerable to occational unavoidable paradoxes barring off branches of knowledge; Empirical questions that are unanswerable are helpful in reckonizing the limitations of theortical knowledge in the human sciences and brings the knower closer to the truth through questioning observationally incorrect answers. However, the scientific method's mixture of a theoretical basis with empirical questioning can increase the rate of knowledge creation and is ultimately a commonly accepted knowledge structure.


\newpage
\cite{encyclopædia_britannica}
\printbibliography
