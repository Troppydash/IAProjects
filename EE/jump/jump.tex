...
\section{Baseline}
I want to set some baseline movement models in this section, for it helps me to visualize the problem and can test my conjuncture in the negligiblity of the continuous approximations.
