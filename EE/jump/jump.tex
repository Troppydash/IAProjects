...
\section{Baseline}
I want to set some baseline movement models in this section, for it not only helps me to visualize the problem, but can also test my conjuncture in the negligiblity of the continuous approximations.

% straight line
The key idea that is repeated throughout this analysis is that maximizing velocity will maximize displacement.  
