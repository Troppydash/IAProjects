...
Let $v_n = \tmag{\tv_n}$, $v_{n+1} = \tmag{\tv_{n+1}}$, and $d = \tmag{d}$. The length of the updated velocity /hypotenuse $v_{n+1}$ using the law of cosine on the opposite angle of $\theta$ is
\[
