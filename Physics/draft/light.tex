...
For a light-bulb to produce light, an electrical current in the form of moving electrical charges must be presented and pass through a light emitting electrical resistor. The ability to produce such electromagnetic waves in the form of visible light is depended on the energy per second passing through the resistor, also known as work, which is defined as:
