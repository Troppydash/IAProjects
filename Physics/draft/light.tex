...
Average the measured illuminance from 5 trials. Figure \ref{fig:average} shows the corrected illumiance values and the averages. Figure \ref{gph:average} plots the averaged illuminance values against the distances.

For example, averaging the illumiance measurements at distance 0.030m:
\begin{align*}
...
Figure \ref{gph:average} looks like an inverse squared graph, so I attempted to straighten it with $1/{\text{distance}}^2$ transformation on the horizontal axis. The transformation data and error is generated with Microsoft Excel (figure \ref{fig:tdata}, graph \ref{gph:tdata}).

For example, at distance 0.030m:
\begin{align*}
 \frac{1}{\text{Distance}^2} &= 0.03 ^ {-2}\\
 &= 1100\,\si{m^-2}\, (2 \tsf)\\
\end{align*}
...
For distance 0.030m:
\begin{align*}
 2 \times \relun \text{Distance} &= 2 \times 0.033 = 0.0667 \,(2 \tsf)\\
 \frac{1}{\text{Distance}^2} &= 1100\, \si{lx} \pm 6.67\%\\
 &= 1100 \pm 100 \,\si{lx}
\end{align*}
